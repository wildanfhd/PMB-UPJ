...
<body>
    ...
    <div class="sticky-top">
        <nav class="navbar navbar-expand-lg navbar-custom navbar-light fw-bold">
            <div class="col-sm-3">
                <a class="navbar-brand text-white" href="#" style="font-size: 13px; font-weight: bold;"><img class="img-responsive" src="../assets/img/upj_logo.png" alt="Logo UPJ" style="width: 80px; margin-right: 8px;">PMB Universitas Pembangunan Jaya</a>
